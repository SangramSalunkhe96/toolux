...
{
  id: "sprint-retro",
  slug: "/tools/sprint-retro",
  title: "Sprint Retrospective Board",
  description: "Anonymous retro board with 3 columns and export.",
  icon: "🧠",
  category: "Team",
  meta: ["Anonymous", "In-browser"],
  pro: false,
  comingSoon: false,
  isPopular: true,
},
{
  id: "daily-standup",
  slug: "/tools/daily-standup",
  title: "Daily Stand-up Notes",
  description: "Yesterday / Today / Blockers summary generator.",
  icon: "📋",
  category: "Team",
  meta: ["Markdown"],
  pro: false,
...
},
{
  ...
  slug: "/tools/retro-action-items",
  title: "Retro Action Item Tracker",
  description: "Track retro action items and export to Jira/Notion.",
  icon: "✅",
  category: "Team",
  meta: ["In-browser"],
  pro: false,
